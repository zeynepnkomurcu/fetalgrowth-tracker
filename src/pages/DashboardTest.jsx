...
export default function Dashboard() {
  ...
  const handleSelectPatient = (index) => {
    ...
    setMeasurements({ AC: "", BPD: "", HC: "", FL: "", EFW: "" });
    ...
    <div className="min-h-screen bg-slate-100 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {/* Patients sidebar — altijd zichtbaar */}
              ...
              {patients.map((patient, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`text-sm mt-1 ${isSelected ? "opacity-90" : "text-slate-500"}`}>
          ...
          {/* Conditional content — empty state of patient workspace */}
          {selectedPatient === null ? (
            <div className="lg:col-span-3">
              <div className="bg-white rounded-3xl shadow-sm p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
            ...
            <div className="lg:col-span-3 grid grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              {/* Left side: Biometry + Growth Curve */}
